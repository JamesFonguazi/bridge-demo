...
<form id="accesspanel" action="login" method="post" @submit.prevent="pressed">
  <h1 id="litheader">SIGNUP</h1>
  <div class="inset">
    <p>
      <input type="text" name="username" id="email" placeholder="New email address" v-model="email" :counter="20" :rules="emailRules" label="Email" required>
    </p>
    <p>
      <input name="password" id="password" placeholder="New access code" v-model="password" type="password" :rules="passwordRules" label="Password" required>
    </p>
    
    <input class="loginLoginValue" type="hidden" name="service" value="login" />
    <router-link to="/"><v-btn color="warning" @click="resetValidation">LOGIN</v-btn></router-link>
  </div>
  <p class="p-container">
    <input type="submit" name="Login" id="go" value="SIGNUP" @click="pressed">
  </p>
</form>
